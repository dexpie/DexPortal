                ...
                <div className="flex gap-4 w-full md:w-auto">
                    ...
                    <div className="relative flex-1 md:w-64">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-sm text-white focus:border-cyan-500 outline-none transition-colors"
                        />
                    </div>
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none bg-white/5 border border-white/10 rounded-lg pl-4 pr-10 py-2 text-sm text-white focus:border-cyan-500 outline-none transition-colors cursor-pointer"
                        >
                            {techStacks.map(tech => (
                                <option key={tech} value={tech} className="bg-neutral-900 text-white">{tech}</option>
                            ))}
                        </select>
                        <Filter className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 pointer-events-none" size={14} />
                    </div>
                </div>
            </div>

    ...
    return (
        <div className="w-full max-w-4xl mx-auto py-20 px-6" ref={containerRef}>
            ...
            <div className="relative">
                ...
                <motion.div
                    style={{ height }}
                    className="absolute left-[20px] md:left-1/2 top-0 w-0.5 bg-gradient-to-b from-red-600 via-red-900 to-transparent -translate-x-1/2 origin-top"
                />
                ...
                <div className="space-y-12">
                    {timelineData.map((item, index) => (
                        ...
                        >
                            {/* Dot */}
                            <div className="absolute left-[20px] md:left-1/2 w-4 h-4 bg-black border-2 border-red-500 rounded-full -translate-x-1/2 z-10 shadow-[0_0_10px_rgba(220,38,38,0.5)]" />
                            ...
                            <div className={cn(
                                ...
                                <div className="p-6 rounded-xl bg-neutral-900/50 border border-white/5 hover:border-red-500/20 transition-colors backdrop-blur-sm group">
                                    <div className={cn(
                                        "flex flex-col gap-1 mb-2",
                                        index % 2 === 0 ? "md:items-end" : "md:items-start"
                                    )}>
                                        <span className="text-xs font-mono text-red-500">{item.date}</span>
